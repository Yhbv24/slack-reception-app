            ...
            <form action="success.php" method="post" name="form" id="form">
              ...
              <div id="text-block">
                <div class="text-input">
                  ...
                  <input placeholder="Your Name" name="guest_name" type="text" maxlength='75' required>
                </div>

                <div class="text-input">
                  <label for="guest_org">Your Organization:</label>
                  <input placeholder="Your Organization" name="guest_org" type="text" maxlength='75' required>
                </div>
